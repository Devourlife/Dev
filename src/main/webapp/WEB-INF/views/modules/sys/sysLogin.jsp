...
<body>
	...
	Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="https://github.com/ourlife/dev" target="_blank">dev</a> ${fns:getConfig('version')}
</body>
</html>