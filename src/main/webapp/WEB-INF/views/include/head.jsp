...
<meta name="author" content="http://ourlife.iteye.com"/><meta http-equiv="X-UA-Compatible" content="IE=7,IE=9,IE=10" />
...
<link href="${ctxStatic}/common/dev.min.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/dev.min.js" type="text/javascript"></script>