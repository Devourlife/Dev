 ...
 */
package com.ourlife.dev.generate;
...
import com.ourlife.dev.common.utils.FileUtils;
import com.ourlife.dev.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String classAuthor = "ourlife";		// 类作者，例：ourlife
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/ourlife/dev/generate/template", "/", separator);
